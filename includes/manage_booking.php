<?php
  ...
  <div class="wrap" style="float:left; width:97%;">
    ...
    <div style="width:47%;float:left;margin-top:15px;">
      ...
      <div style="float:left;padding-left:3px;"><h2><?php _e("Manage hall Booking","sc-scbooking"); ?> </h2></div>
    </div>
    ...
    <div class="main_div">
        ...
        <h3 class="top_bar"><?php _e("Manage Hall Booking","sc-scbooking"); ?></h3>
          ...
          <thead>
            <tr>
              ...
              <th><?php _e("Hall","sc-scbooking"); ?></th>
              <th><?php _e("Booking date","sc-scbooking"); ?></th>           
