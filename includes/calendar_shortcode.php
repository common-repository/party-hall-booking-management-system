    ...
    $y.= "</select>";  
		$output .='<div style="width:100%;">
			...
			<table id="calendarhead" style="width:100%!important;">
              ...
              '.$y.'
					...
					<td id="showmonthyear" style="padding-left:10px;font-size:12px">
        ...
        #calendar_front{
          border: 1px solid #cccccc;
				...
				//=============================
				$output .= '<div style=""><table id="calendar_front" cellspacing="0" cellpadding="0"><tr style="font-size:12px;background-color:#0099FF;color: #ffffff; font-family: arial;"><td width="100px"><div style="font-weight: bold;">'.__("Hall","sc-scbooking").'</div></td>';
